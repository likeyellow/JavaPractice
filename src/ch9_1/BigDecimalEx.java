...
public class BigDecimalEx {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.print(bd1.divide(bd2, 2, HALF_UP)); // 123.46
		System.out.print(bd1.setScale(2, HALF_UP)); // 123.46
		System.out.print(bd1.divide(bd2, new MathContext(2, HALF_UP)));
